...
function drawMyWorld(squares, name) {
    for (let i = 0; i < squares.length; i++) {
        ...
        mySquare1.style.transform = `translate3d(${squares[i][0]}px, ${squares[i][1]}px, ${squares[i][2]}px) rotateX(${squares[i][3]}deg) rotateY(${squares[i][4]}deg) rotateZ(${squares[i][5]}deg)`;
